...
(function (JB) {
  var $ = JB.$, $$ = JB.$$;
  var hdr = $("#hdr"), hero = $("#top"), menu = $("#menu"), menubtn = $("#menubtn");
  function setMenu(o) { menu.classList.toggle("open", o); menubtn.setAttribute("aria-expanded", o ? "true" : "false"); menubtn.textContent = o ? "Close" : "Menu"; document.body.style.overflow = o ? "hidden" : ""; hdr.classList.toggle("on-hero", !o && hero.getBoundingClientRect().bottom > 80); }
